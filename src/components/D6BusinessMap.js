    ...
    loadApp(app) {
        ...
        switch (app.getAttribute('data-app-state')) {
            ...
            case 'active-info':
                ...
                <a href="https://survey123.arcgis.com/share/d7202441b34a4ffaaa3989fe3426a7f3?" target="_blank">${this.languageText[currentLanguage]['info'][11]}</a> ${this.languageText[currentLanguage]['info'][12]}
                `;
